...
export const PoliticasPrivacidadeContainer = styled.section`
  max-width: 1300px;
  width: 100%;
  margin: 0 auto;
...
function PoliticasPrivacidade() {
  return (
    <div id='politicas'>
      <Head>
        <title>Blog | Cebrac Unidade de Londrina</title>
      </Head>
      <Header />
      <PoliticasPrivacidadeContainer>
        <main id="politicas">
          <h1>Política de Privacidade</h1>

          <div>
            <p><span>A sua privacidade é importante para nós. É política do Cebrac Cuiaba-PR respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://www.cuiabacebrac.com.br/">Cebrac Cuiaba-PR</a>, e outros sites que possuímos e operamos.</span></p>
            ...
            <ul>
              ...
              <li><span>C&#41; Não causar danos aos sistemas físicos &#40;hardwares&#41; e lógicos &#40;softwares&#41; do Cebrac Cuiaba-PR, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</span></li>
            </ul>
            ...
            <p><span>Esta política é efetiva a partir de&nbsp;</span><strong>13 December 2022 18:12</strong></p>
          </div>
        </main>
      </PoliticasPrivacidadeContainer>
      <ScrollToTop />
